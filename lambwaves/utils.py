...
def correct_instability(result, function):
    ...
    result : array
        ...
        A0, A1, A2, etc.)
    function : object
        Family of modes to solve (symétrique or antisymétrique).
    ...
    # Compensate for antisymétrique mode (A0 is strictly increasing).
    
    n = 1 if function.__name__ == '_symétrique' else 2
